...
#needed to get data IN JYDOOP FORMAT from HDFS
...
def map(key, value, context):
    ...
    #otherwise
    ### the key will be a (firstDay,hash(firstDayDataStr)) tuple fingerprint
    ### and the value will be a list of thisPingDates for each record associated with the fingerprint. there should be at least two thisPingDates

    context.write(len(list(value)),1)
